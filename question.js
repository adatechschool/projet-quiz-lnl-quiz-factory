  ...
  questions: [
    {
      ...
      options: [
        ...
        `Un langage de balisage utilisé pour structurer le contenu d'une page web.`,
    ...
    },
    {
      ...
      options: [
        `'==' compare uniquement les types, '===' compare uniquement les valeurs`,
    ...
    },
    {
      ...
      options: [
        ...
        `Créer des Sites Superbes`,
      ],
      correct_answer: `Cascading Style Sheets`,
    },
    {
      text: `Quelles sont les trois unités de mesure les plus courantes en CSS pour définir les longueurs ?`,
      options: [`px, cm, mm`, `px, em, rem`, `pt, pc, in`, `%, vw, vh`],
      correct_answer: `px, em, rem`,
    },
  ],
};
